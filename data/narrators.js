export const NARRATOR = {
  setup: (n, d, p) =>
    `The year is 2082 B.S. Nepal stands at a crossroads. ${n}, a determined leader from ${d}, has been nominated by the ${p.name} to contest the parliamentary seat. The party's PM candidate, ${p.pm}, has staked everything on winning a majority. If ${p.short} captures 138 or more seats, ${p.pm} becomes Prime Minister — and ${n}'s seat in ${d} is essential.`,
  campaign: (d, iss) =>
